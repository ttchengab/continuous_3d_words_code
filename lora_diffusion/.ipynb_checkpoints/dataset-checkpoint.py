...
category = " cgi rendered chair in a white background"
OBJECT_TEMPLATE = [
...
class PivotalTuningDatasetCapation(Dataset):
    ...
    def __init__(
        ...
        # instance_data_root = Path("/home/tayingc/sensei-fs-symlink/users/tayingc/2023/lora_piv/data/single_chair")
        print(instance_data_root.exists())
